...
def get_and_process_data():
    ...
    exclude_starts = [
        "Автокондиционер", "Автосигнализация", "Автоэлектрика", "Болт М",
        "Бутылка", "Гайка М", "Эфир", "Заклепки для", "Гильза силового провода",
        "Герметик-прокладка", "Шайба", "Упл.кольцо", "Хомут", "Клемма", "Расходные материалы",
        "Смазка", "ТАРА", "Тормозная жидкость", "Шпилька", "Шплинт", "Шиномонтаж",
        "Штифт"
    ]
